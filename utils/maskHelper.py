...
class MaskImage:
    def __init__(self):
        ...
        The following attributes are initialized to None:
            ...
            - points: The points of the contours.
            - annotations: The annotations of the contours.
            - masked_image: The masked image.
            - area: The area of the contours.
            - temp: The temporary image.
    ...
    def maskProcessor(self, mask, tolerance=20, returnAll=False):
        ...
        try:
            self.mask = mask
            print(f'**** Segment status : {mask.any()} ******')
            if mask.any():
            ...
            #When no segment is generated, area can't be calculated
            return None, None 
